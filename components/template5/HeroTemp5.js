...
const HeroTemp5 = forwardRef((props, ref) => {
  ...
  return (
    <div ref={ref} id={dataObj.key} className={`group px-4 sm:px-0`}>
      ...
      >
        <div className=" text-customt5 font-Poppins">
          <div className="flex flex-col">
            <div className="w-full h-30">
              <div className="p-10 xl:p-20">
                <div className="w-full h-70">
                  <p className="break-words w-8/12 text-lg md:text-xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold">
                    {dataObj.data.title}
                  </p>
                </div>
              </div>
