...
const Hero3Temp3 = forwardRef((props, ref) => {
    ...
    <div ref={ref} id={dataObj.key} className={`group px-4 sm:px-0`}>
      ...
      >
        <div className="p-4 xl:p-20 font-Poppins">
          <div className="flex flex-col xl:flex-row border-customblue border border-r-white">
            <div className="w-full xl:w-1/2 p-4 xl:p-12">
              <div className="">
                <h2 className="text-xl lg:text-2xl xl:text-4xl font-bold ">
                  Praesent dapibus, neque id cur faucibus, tortor neque
                </h2>
            ...
            <div className="w-full xl:w-1/2 order-first xl:order-last">
              <img
