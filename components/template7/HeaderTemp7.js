...
const HeaderTemp7 = forwardRef((props, ref) => {
  ...
  return (
    <div ref={ref} className={classNames(" group h-auto ", fontFam?.name)}>
      <Disclosure as="nav" className="font-Poppins ">
      <nav
        ...
        {({ open }) => (
          <>
            <div className="mx-auto max-w-full px-4 sm:px-8 md:px-12 lg:px-16 xl:px-20 2xl:px-24 py-4 xl:py-4 2xl:py-9">
              <div className="relative flex h-16 items-center justify-between">
                ...
                <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                  <div className="flex flex-shrink-0 items-center">
                    <h3 className="font-bold text-lg lg:text-2xl xl:text-3xl 2xl:text-4xl">
                    ...
                    {dataObj.data.navigation.map((item) => (
                        <a
                          ...
                          className={classNames(
                            ...
                            "rounded-md px-3 py-2 text-sm md:text-xl 2xl:text-2xl font-light"
                          )}
              ...
              {dataObj.data.navigation.map((item) => (
                  <Disclosure.Button
                    ...
                    className={classNames(
                      ...
                      "block rounded-md px-3 py-2 text-sm md:text-2xl xl:text-2xl font-medium text-center "
                    )}
                    aria-current={item.current ? "page" : undefined}
                  >
                    {item.name}
