...
const Contact1 = forwardRef((props, ref) => {
  ...
  return (
    <>
      <div
        ref={ref}
        id={dataObj.key}
        className={`group relative bg-white py-4 sm:py-14 ${fontFam?.name}`}
      >
        ...
        <div className="relative mx-auto max-w-full lg:grid lg:grid-cols-7 sm:px-8 px-4 sm:gap-10 gap-4 md:items-center">
          <div className="bg-white lg:col-span-4">
            <div className="py-2 sm:py-0">
              <h2
                className={`text-3xl font-bold tracking-tight sm:text-5xl text-${themeColor.name}-500`}
              >
          ...
          <div className="bg-gray-50 sm:py-0 py-0 px-0 lg:col-span-3 sm:px-0">
            <div className="mx-auto">
              <img
                className="w-full sm:h-full max-h-[[600px]] object-cover"
