...
export default function FeatureInsuranceAgent() {
  return (
      ...
      <div className="mx-auto max-w-2xl px-12 py-12 sm:px-6 sm:py-24 lg:max-w-full lg:px-25">
        <div className="relative">
          ...
          <div className="relative flex justify-start">
            <h2 className="text-[40px] font-bold tracking-tight text-[#447D98] pb-[46px]">
              Our Products
            </h2>
          </div>
        </div>
          ...
          {products.map((product) => (
            <div key={product.id} className="group relative">
              ...
              <div className="mt-8 flex justify-between">
                <div>
                  <h3 className="text-[28px] font-bold text-[#393A52]/90">
                    <a href={product.href}>
                      <span aria-hidden="true" className="absolute inset-0" />
                      {product.name}
                    </a>
                  </h3>
                  <p className="mt-1 tracking-tight text-[24px] text-[#707070]/70 font-normal pr-4">
                    {product.desc}
                  </p>
                </div>
              </div>
