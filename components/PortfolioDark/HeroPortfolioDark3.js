...
export default function HeroPortfolioDark3() {
  return (
    <div className="bg-herobg3 ">
      <div className="mx-auto max-w-full px-6 pt-10  lg:px-0 lg:pt-[131px] lg:pb-[102.5px]">
        <div className="mx-auto max-w-2xl lg:max-w-none">
          ...
          <div className=" flex pt-[66px] flex-col lg:flex-row">
            ...
            <div className="2xl:pl-24 pl-40 sm:pl-0  ">
              <dl className="mt-16 grid grid-cols-1 overflow-hidden rounded-2xl text-left sm:grid-cols-2 lg:grid-cols-3 space-x-24 ">
                {stats.map((stat) => (
