...
const GalleryInsurance = () => {
  return (
    <div className="bg-insurancecolor3 px-12 pt-12 pb-12 2xl:px-25 2xl:pt-[89px] 2xl:pb-[104px]">
      <div className="relative">
        ...
        <div className="relative flex justify-start">
          <h1 className="text-[40px] text-insurancecolor font-bold mb-24">
            Video Gallery
          </h1>
        </div>
      </div>
...
export default GalleryInsurance;
