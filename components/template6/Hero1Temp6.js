...
const Hero1Temp6 = forwardRef((props, ref) => {
  ...
  return (
    <div ref={ref} id={dataObj.key} className={`group px-4 sm:px-0`}>
      ...
      >
        <div className="overflow-hidden bg-white  sm:py-0 font-Poppins">
          <div className="max-w-full">
            <div className="relative w-full grid grid-cols-1  sm:flex items-center justify-start h-full">
              <img
                src={dataObj.data.image}
                alt="hero Image"
                className="w-[100%] ring-1 ring-gray-400/10 sm:w-[60%]  max-h-full   sm:max-h-[850px] object-cover"
              />
              <div className="sm:absolute relative flex w-full justify-center md:ml-56 lg:ml-48 xl:ml-72 2xl:ml-96 sm:ml-96 ">
                <div
                ...
                >
                  ...
                  <p className="mt-6 text-md xl:text-lg 2xl:text-2xl font-thin text-customt31 tracking-wide h-truncate pl-12 pr-12">
