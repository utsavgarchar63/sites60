...
const HeaderTemp6 = forwardRef((props, ref) => {
  ...
  return (
    ...
    <Disclosure as="nav" className="bg-customblue6 font-Poppins">
              <nav
      ...
      {({ open }) => (
        <>
          <div className="mx-auto max-w-full px-6 py-4 xl:px-20 xl:py-9 ">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <h3 className="font-bold text-lg md:text-xl lg:text-3xl xl:text-4xl text-customt32">SiteName</h3>
                </div>
              </div>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          ...
                          "rounded-md px-6 py-2 text-md xl:text-2xl font-medium"
                        )}
            ...
            <div className="space-y-5 px-2 pb-3 pt-2 min-h-screen">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  className={classNames(
                    item.current
                      ? "bg-white  text-customt32"
                      : " text-customt32",
                    "block rounded-md px-3 py-2 text-sm md:text-2xl xl:text-2xl font-medium text-center  text-customt32 "
                  )}
                  aria-current={item.current ? "page" : undefined}
                >
                  {item.name}
