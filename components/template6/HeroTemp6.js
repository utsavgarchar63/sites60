...
const HeroTemp6 = forwardRef((props, ref) => {
  ...
  return (
    <div ref={ref} id={dataObj.key} className={`group px-4 sm:px-0`}>
      ...
      >
        <div className="p-4 xl:p-20 bg-customblue6 font-Poppins">
          <div className="flex flex-col">
            <div className="w-full h-70 ">
              {/* Top part with an image */}
              <img
            ...
            <div className="w-full h-30 ">
              ...
              <div className="w-full xl:w-[65%]  h-70 p-4 py-6">
                <p className=" text-lg md:text-2xl xl:text-4xl 2xl:text-6xl text-customt32 mt-10">
                  {dataObj.data.title}
                </p>
              </div>
            </div>
