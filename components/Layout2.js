...
const navigation = [
  { name: "My Websites", href: "/", icon: HomeIcon, current: true },
  {
    name: "Templates",
    href: "/templates",
    icon: TableCellsIcon,
  ...
  { name: "Templates", href: "/analytics", icon: ChartBarIcon, current: false },
  { name: "Settings", href: "/domain", icon: GlobeAltIcon, current: false },
  { name: "Support", href: "/profile", icon: UserIcon, current: false },
...
export default function Layout({ children }) {
  ...
  } else if (router.asPath == "/analytics") {
    for (let i = 0; i < navigation.length; i++) {
      if (i == 2) {
