...
const Hero12 = forwardRef((props, ref) => {
      ...
      >
        <div className="overflow-hidden bg-white py-14">
          <div className="max-w-full">
            <div className="relative w-full grid grid-cols-1 sm:flex items-center justify-end h-full">
              <div className="sm:absolute relative flex w-full justify-center sm:mr-56 mr-0">
                <div
                  className={`sm:max-w-3xl max-w-xl bg-${themeColor.name}-50 md:py-20 py-4 md:px-20 px-2 max-h-[[200px]] sm:max-h-[350px]`}
                >
                  <p
              ...
              <img
                ...
                className="w-[100%] max-w-none ring-1 ring-gray-400/10 sm:w-[60%] max-h-full sm:max-h-[650px] object-cover"
              />
            </div>
          </div>
        </div>
