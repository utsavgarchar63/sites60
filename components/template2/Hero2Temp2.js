...
const Hero2Temp2 = forwardRef((props, ref) => {
      ...
      >
        <div className="grid grid-cols-1 items-center sm:p-16 sm:pb-20 bg-customblack">
          <div className="flex flex-col sm:flex-row">
            ...
            <div className="sm:w-full sm:px-0 px-6 relative mr-12 mb-10 flex items-center">
              <div className="border w-72 h-56 sm:w-[700px] sm:h-[495px] border-solid border-custom-orange border-t-opacity-60"></div>

              <img
                src={dataObj.data.image}
                alt="Testimonial Image"
                className="w-72 h-56 sm:w-[700px] sm:h-[495px] object-cover absolute top-10 sm:top-12 left-12 sm:left-8 -mt-4 -mr-4"
              />
            </div>
          </div>
        </div>
