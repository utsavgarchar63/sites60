...
// export default function HeroTemp1() {
const HeroTemp1 = forwardRef((props, ref) => {
  ...
  return (
    <div ref={ref} className={`group bg-white`}>
      <div
        id={dataObj.key}
      ...
      >
        <div className="relative isolate overflow-hidden bg-white">
          <img
            ...
            alt=""
            className="absolute inset-0 -z-10 h-96 w-full sm:h-full sm:w-full object-cover object-center"
          />
          <div className="px-6 lg:px-0 relative">
